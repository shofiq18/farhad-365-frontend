          ...
          <div className="flex flex-col justify-center p-6 mt-20 mb-12 md:mx-24 bg-white">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="text-right">
                <a href="/forgot-password" className="text-sm font-semibold text-gray-600 hover:text-black transition">
                  Forgot password?
                </a>
              </div>
            ...
            <div className="mt-6 text-center text-sm">
              <p className="text-gray-600">
                ...
                <Link href="/sign-up" className="font-semibold text-black underline hover:text-neutral-600">
                  Sign Up
                </Link>
              </p>
